...
public class TutorialSkillController : MonoBehaviour
{
    public static TutorialSkillController Inst
    {
        get; private set;
    }
    ...
    public void SelectSkill()
    {
        ...
        {
            skillSlots[i].selectBtn.SetActive(true);
        }
    }
    public void SelectTutoSkill()
    {
        SelectSkillCard(0, 0, 1);
    }
