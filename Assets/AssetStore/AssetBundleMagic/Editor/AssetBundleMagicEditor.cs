    ...
    public class AssetBundleMagicEditor : Editor
    {
        ...
        public override void  OnInspectorGUI ()
        {
            ...
            if (!Directory.Exists (man.BundlesBasePath) || new DirectoryInfo (man.BundlesBasePath).GetDirectories ().Length == 0) {
                EditorGUILayout.HelpBox ("Warning: No Bundles. Please build bundles for your platform by selecting one or more platform and pressing the \"Build All Asset Bundles\" button.", MessageType.Warning);
            }
